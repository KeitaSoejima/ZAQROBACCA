...
<meta name="description" content="Andy Cafeの自社農園 AndyFarmでは、神奈川県厚木市に農地を借り、土作りから行い、野菜の栽培をしています。農薬を使わない自然由来の栽培方法でお客様に安全・安心をお届けします。">
...
<div id="hero" class="ratio-1_1">
			 <div class="inner">
			 	<div id="slidenav"></div>
			 	<ul id="slideshow">
					<!--<li><img src="https://andycafe.com/photo_session_html/images/main_img01.png"></li>-->
					<li><img src="https://andycafe.com/photo_session_html/images/main_img02.png"></li>
					<li><img src="https://andycafe.com/photo_session_html/images/main_img03.png"></li>
				</ul>
			</div>
</div>